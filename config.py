...
REQUIRED_TOOLS = {
    ...
    'massdns': 'https://github.com/blechschmidt/massdns (build from source or apt install)',
...
def validate_requirements(skip_expansion_tools=False):
    """
    Validate all requirements for reconflex tool
    ...
    """
    print("\n" + "="*60)
    print("[*] Validating Reconflex Requirements...")
    print("="*60 + "\n")
